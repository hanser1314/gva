<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="上课地点、时间" prop="cplace" width="150" />
...
import { getSctListBySno } from '@/api/sct'
...
const getTableData = async() => {
  ...
  // }
  const table = await getSctListBySno({ page: page.value, pageSize: pageSize.value, sno: username.value })
  if (table.code === 0) {
    tableData.value = table.data.list
    total.value = table.data.total
    page.value = table.data.page
